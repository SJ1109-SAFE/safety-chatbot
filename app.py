...
### [필수 판정 기준]
1. **안전관리자, 보건관리자, 신호수, 유도자, 작업지휘자 임금**: 고시 제7조 제1항 제1호에 따라 '안전·보건관리자 임금 등' 항목으로 전액 사용 가능 (안전관리자 선임 현장에서 산재예방 업무 전담 시). 절대 '구매 불가'나 '안전시설비'로 오분류하지 마라.
